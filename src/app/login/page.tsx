        ...
        <div className="flex items-center justify-center p-6 lg:p-12">
          <Card className="w-full max-w-md p-8 shadow-xl">
            <div className="flex flex-col items-center">
              ...
              <p className="mt-1 text-sm text-muted-foreground">Continue your journey to German mastery</p>
            </div>
            ...
            <form onSubmit={onSubmit} className="mt-8 space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <button type="button" className="text-xs font-medium text-[var(--primary)] hover:underline">
                    Forgot password?
                  </button>
                </div>
                <div className="relative">
              ...
              <div className="text-center text-xs text-muted-foreground">
                ...
                <button type="button" onClick={() => router.push('/signup')} className="font-semibold text-[var(--primary)] hover:underline">
                  Create one for free
                </button>
              </div>
            </form>
